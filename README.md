# Tp2-Programation-avancee-en-python
...
# 🐍 Solutions TP2 - Programmation Avancée en Python
...
* [cite_start]**Exercice 2 :** Comptage des occurrences d'éléments dans une liste avec `count()` et formatage en tuples[cite: 7].
* [cite_start]**Exercice 3 :** Utilisation des modules `calendar` et `datetime` pour afficher le mois en cours et une horloge temps réel[cite: 10].
* [cite_start]**Exercice 4 :** Traçage de graphiques avec Matplotlib, en utilisant des `subplots` séparés pour $sin(t)$, $cos(t)$, et $exp(-t)$[cite: 12].
* [cite_start]**Exercice 5 :** Filtrage d'un DataFrame Pandas pour sélectionner des lignes selon un intervalle de score[cite: 14].
